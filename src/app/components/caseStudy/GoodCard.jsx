  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col justify-center items-center mb-8">
        ...
        <div
          className="w-20 h-1 bg-gradient-to-r from-transparent via-green-500 to-transparent 
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Feature 1 */}
        <div
          className="flex flex-row-reverse items-center gap-4 p-4 rounded-lg bg-black/20 hover:bg-black/30 
